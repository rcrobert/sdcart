...
class DisplayManager(object):
    ...
    def change_screen(self, screen):
        ...
        # Display new screen and save current
...
class HomeScreen(ListScreen):
    def __init__(self, root, event_callback):
        ...
        self.produce_button.grid(row=0, column=4)
        ...
        self.remove_button.grid(row=1, column=4)
        ...
        self.help_button.grid(row=2, column=4)
...
class PictureScreen(ListScreen):
    def __init__(self, root, event_callback):
        ...
        self.accept_button.grid(row=0, column=4)

        self.take_picture_button = Button(self, text='Take Picture', command=self._take_picture_button_callback)
        self._change_fontsize(self.take_picture_button, 14)
        self.take_picture_button.grid(row=1, column=4)
        ...
        self.advice_label = Label(self, text='Ensure that produce item is completely visible inside of frame.')
        self._change_fontsize(self.advice_label, 14)
        self.advice_label.grid(row=4, column=0, columnspan=5, sticky=N+E+S+W)
    ...
    def update_image(self, image_name):
        ...
        if image_name:
            ...
            self.image = ImageTk.PhotoImage(Image.open(image_name))
...
class ProduceScreen(ListScreen):
    def __init__(self, root, event_callback):
        ...
        self.select_button = Button(self, text='Select', command=self._select_button_callback)
        ...
        self.new_picture_button.grid(row=1, column=4)
